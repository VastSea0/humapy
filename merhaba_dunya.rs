...
fn main() {
    let inst = vec![OpCode::PushConstant(0), OpCode::DefineVar("x".to_string()), OpCode::PushConstant(1), OpCode::DefineVar("y".to_string()), OpCode::PushConstant(2), OpCode::Print, OpCode::LoadVar("x".to_string()), OpCode::LoadVar("y".to_string()), OpCode::Add, OpCode::Print, OpCode::LoadVar("x".to_string()), OpCode::LoadVar("y".to_string()), OpCode::Less, OpCode::JumpIfFalse(17), OpCode::PushConstant(3), OpCode::Print, OpCode::Jump(19), OpCode::PushConstant(4), OpCode::Print];
    let cons = vec![Constant::Sayi(10.0), Constant::Sayi(20.0), Constant::Metin("x + y toplamı:".to_string()), Constant::Metin("x, y'den küçüktür.".to_string()), Constant::Metin("x, y'den küçük değildir.".to_string())];
